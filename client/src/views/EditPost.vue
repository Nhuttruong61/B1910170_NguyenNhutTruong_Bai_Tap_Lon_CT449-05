        ...
        <v-app-bar app>
            <v-toolbar-items>
                <v-toolbar-items>
                    ...
                    <!-- <v-btn to="/comment" text> Comment</v-btn>
                    <v-btn to="/addcomment" text> Add Comment</v-btn> -->
            ...
            <v-col sm="10" class="mx-auto">
                <v-card class="pa-5">
                    ...
                    <v-form ref="form" @submit.prevent="updateForm" class="pa-5" enctype="multipart/form-data">
                        ...
                        <v-btn type="cancel" class="mt-3" color="error"
                            :to="{ name: 'post', params: { id: post._id } }">CANCEL</v-btn>
                    </v-form>
                </v-card>
            </v-col>
        </v-row>
